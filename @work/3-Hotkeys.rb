...
# quit Windawesome
subscribe modifiers.Alt | modifiers.Shift | modifiers.Control, key.Q do
	windawesome.quit
end

# refresh Windawesome
subscribe modifiers.Alt | modifiers.Shift | modifiers.Control, key.R do
...
subscribe modifiers.Alt, key.T do
	Windawesome::Utilities.run_application "C:\\cygwin64\\bin\\mintty.exe"
end

# start ranger
subscribe modifiers.Alt, key.R do
	Windawesome::Utilities.run_application "C:\\cygwin64\\bin\\mintty.exe", "/usr/bin/ranger"
end
...
subscribe modifiers.Alt | modifiers.Shift, key.H do
